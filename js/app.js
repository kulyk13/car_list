  ...
  return `<div class="col card mb-3">
    <div class="row g-0">
      ...
      <div class="col-8">
        <div class="card-body">
          <a href="#"
            class="card-title mb-3">${card_data.make} ${card_data.model}
            ${card_data.engine_volume} (${card_data.year})</a>
          <h3 class="card-price">${card_data.price} $</h3>
          <h4 class="card-rating text-warning">${starIcons} ${card_data.rating}</h4>
          <div class="card-info mt-4">
            ...
            ${card_data.vin ? `<div class="vin-block">
            <h4>VIN</h4>
            <div class="card-vin">${card_data.vin}</div>
          </div>` : ''}
            <div class="color mt-4">Колір: ${card_data.color}</div>
            <div class="contact-block mt-4">
              <a href="tel:${card_data.phone}" class="call-num">
                <i class="fas fa-phone-alt"></i>
                Подзвонити
              </a>
              <p>${card_data.seller}</p>
            </div>
            <button type="button" class="save-star btn-secondary"><i class="far fa-star"></i></button>
          </div>
        </div>
      </div>
